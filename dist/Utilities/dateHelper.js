...
var calendarDate = (function () {
  ...
  return function (momentDate, withoutTime) {
    ...
    var calDate = momentDate.calendar();
...
var dateHelper = {
  ...
  dateValueOrDefault: function dateValueOrDefault(date) {
    return date && (date === '1900-01-01T00:00:00' || date === '0001-01-01T00:00:00' || date === '/Date(-62135578800000)/' || date === '/Date(-2208970800000)/') ? null : date;
  },
  ...
  customDistance: function customDistance(date, fromDate) {
    ...
    dateDiff = isPastDate ? ['in', dateDiff, dateDiffShort].join(' ') : [dateDiff, dateDiffShort, 'ago'].join(' ');

    return dateDiff;
  },

  prettyDateDistance: function prettyDateDistance(date) {
